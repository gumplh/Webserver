...
std::shared_ptr<HttpData> Channel::getHolder() { return holder_; }
void Channel::setCallRead(CallBack &&cb) { callRead_ = cb; }
void Channel::setCallWrite(CallBack &&cb) { callWrite_ = cb; }
void Channel::setRevent(const __uint32_t &e) { revent_ = e; }
void Channel::setEvent(const __uint32_t &e) { event_ = e; }
